...
class TextStyleCollection {
  ...
  static const TextStyle secondaryHeadingTextStyle = TextStyle(
      fontSize: 14, color: AppColors.infoMsgColor, fontWeight: FontWeight.w600);

  static const TextStyle activityTitleTextStyle = TextStyle(
      fontSize: 14, color: AppColors.infoMsgColor, fontWeight: FontWeight.w600);

  static const TextStyle normalTextStyle = TextStyle(
      fontSize: 16, color: AppColors.infoMsgColor, fontWeight: FontWeight.w600);
  ...
  static const TextStyle terminalTextStyle = TextStyle(
      fontSize: 12, color: AppColors.infoMsgColor, fontWeight: FontWeight.w600);
}
